 ...
 * размер, цвет, код ткани и вид. Две шторы одной модели разного размера —
 * разные товары, и продать вместо одной другую нельзя.
 *
...
export const readyMadeItems = pgTable(
  'ready_made_items',
  {
    ...
    */
    ...
    /** Код ткани с этикетки. Может отсутствовать: этикетку теряют. */
