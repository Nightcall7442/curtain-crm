...
export const fabricStock = pgTable(
  'fabric_stock',
  {
    ...
    */
    ...
    /** Код с этикетки — тот же, что продавец вводит в заказе. */
    code: varchar('code', { length: 100 }).notNull(),

    /**
     * Мини-описание: чем эта позиция отличается — оттенок, плотность, размер.
     *
     * Своё, а не из справочника кодов: на складе лежит конкретная партия, и
     * приписка «тёмная сторона, из последней поставки» относится к ней, а не
     * ко всем рулонам с этим кодом.
     */
