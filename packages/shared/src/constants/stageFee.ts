...
export const ORDER_STAGE_FEE_ROLE = {
  ...
  */
  ...
  qc: Role.QC,
  /*
    Карниз — работа карнизчика, а не установщика.

    Сначала обе строки числились за установщиком: «те же люди, просто другая
    работа». На деле карниз вешают до установки штор и часто другие руки, а в
    назначении заказа из-за общей роли стояли два «Установщика» подряд — по
    ним нельзя было понять, кто что делает. Теперь у карниза своя роль, своя
    очередь и своя сдельная строка.
  */
  cornice: Role.CORNICE_INSTALLER,
