        ...
        {isRecording ? (
          <>
            ...
            <button
              type="button"
              onClick={stop}
              className="ml-auto flex items-center gap-1.5 rounded-xl border border-ink/10 px-2.5 py-1.5 text-footnote text-primary transition-colors hover:bg-ink/[0.08]"
            >
