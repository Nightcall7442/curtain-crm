...
function ToastCard({
  ...
  return (
    <div
      ...
      className={cn(
        'toast-enter pointer-events-auto flex items-start gap-2.5 rounded-2xl border border-white/[0.08]',
    ...
    >
      ...
      <button
        ...
        className="pressable -m-1 grid h-6 w-6 shrink-0 place-items-center rounded text-muted hover:bg-white/[0.08] hover:text-primary"
      >
