  ...
  return (
    <section className="surface-hero relative flex h-full flex-col overflow-hidden p-6">
      ...
      <p className="mt-4 flex flex-wrap items-baseline gap-x-2 gap-y-1">
        <span className="hero-number text-[46px] font-semibold leading-none tracking-[-0.02em] [font-variant-numeric:tabular-nums]">
          {value}
        </span>
          ...
          {stats.map((stat) => (
            <div key={stat.label} className="min-w-[120px]">
              ...
              <dd className="mt-1 flex flex-wrap items-center gap-2">
                <span className="text-display font-semibold leading-none tracking-[-0.02em] text-primary [font-variant-numeric:tabular-nums]">
                  {stat.value}
                </span>
  ...
  const body = (
    <>
      ...
      <p className="mt-3 flex items-end gap-4">
        <span className="text-[50px] font-semibold leading-none tracking-[-0.02em] text-primary [font-variant-numeric:tabular-nums]">
          {value}
        </span>
    ...
    <section className="surface-card flex h-full flex-col p-6">
      ...
      {headline !== undefined && (
        <p className="mt-4 flex items-end gap-3">
          <span className="text-[42px] font-semibold leading-none tracking-[-0.02em] text-primary [font-variant-numeric:tabular-nums]">
            {headline.value}
          </span>
