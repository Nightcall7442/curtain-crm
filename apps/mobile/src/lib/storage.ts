...
export interface SavedAccount {
  ...
  /**
   * Фото для круга в переключателе.
   *
   * Ссылка подписана и живёт ограниченное время, поэтому запись без неё
   * (и с протухшей) обязана оставаться рабочей: круг просто покажет
   * инициалы. Хранить её всё равно стоит — обычно между открытиями
   * переключателя проходят минуты, и лицо узнаётся быстрее имени.
   */
