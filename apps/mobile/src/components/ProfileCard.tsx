...
const styles = StyleSheet.create({
  ...
  photo: {
    /*
      Ширину задал владелец: 104 было мелко для портрета — лицо в такой
      рамке читалось хуже, чем на пропуске. Колонка полей рядом ужимается
      сама (`flex: 1`), а длинные значения переносятся на вторую строку,
      поэтому расширение рамки ничего не обрезает.
    */
    width: 136,
    /*
