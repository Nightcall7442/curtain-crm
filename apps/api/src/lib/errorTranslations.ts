...
const EXACT: Readonly<Record<string, string>> = {
  ...
  'Конец мероприятия раньше начала': 'Tadbir tugashi boshlanishidan oldin',
  'Не удалось сохранить мероприятие': "Tadbirni saqlab bo'lmadi",
  'Мероприятие не найдено': 'Tadbir topilmadi',
  ...
  'Наличные руководства и так в кассе — сдавать нечего': "Rahbariyat naqd puli allaqachon kassada — topshiradigan narsa yo'q",
  'Чек без прихода заводит продавец или руководство': "Tushumsiz chekni sotuvchi yoki rahbariyat kiritadi",
  'Приход по карте не найден или не ваш': "Karta orqali tushum topilmadi yoki sizniki emas",
  'В системе нет ни одного филиала': "Tizimda birorta filial yo'q",
  'Возврат больше, чем оплачено по заказу': "Qaytarish buyurtma bo'yicha to'langandan ko'p",
  'Сумма больше остатка по заказу': "Summa buyurtma qoldig'idan katta",
  'Сначала начните смену': 'Avval smenani boshlang',
